...
//        pc.setModuleName("sys");
        ...
        focList.add(new FileOutConfig(xmlTemplatePath) {
            ...
            public String outputFile(TableInfo tableInfo) {
                ...
                return projectPath + "/systemdao/src/main/resources/mapper/" + pc.getModuleName()
        ...
        templateConfig.setService("templates/dao.java");//更改为null不输出dao
        templateConfig.setServiceImpl("templates/daoImpl.java");//更改为null不输出daoImpl

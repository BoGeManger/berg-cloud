...
public class MybatisplusGenerator {
    ...
    public static class GeneratorConfig{
        //数据库主模块名称
        String parentModuleName = DataSource.LOG;
        //多数据源标识
        ...
        String driver = "mysql";
        //数据库访问地址
        String url = "jdbc:mysql://localhost:3306/clouddb?useUnicode=true&serverTimezone=GMT&useSSL=false&characterEncoding=utf8";
        //数据库驱动

...
public class MinioUtil {
     ...
     * @throws Exception
     */
    public static ObjectStat statByName(String objectName) throws Exception{
        return minioClient.statObject(bucketName, objectName);
    }
     ...
     * @return
     */
    public static boolean checkByName(String objectName){
        boolean isExist = true;
        try{
            // 调用statObject()来判断对象是否存在。
            // 如果不存在, statObject()抛出异常,
     ...
     * @throws Exception
     */
    public static InputStream getByName(String objectName) throws Exception{
        InputStream stream = null;
        if(checkByName(objectName)){
            // 获取的输入流。
            stream = minioClient.getObject(bucketName, objectName);
        }
        return stream;
     ...
     * @throws Exception
     */
    public static InputStream getByName(String objectName, long offset, Long length)throws Exception{
        InputStream stream = null;
        if(checkByName(objectName)){
            // 获取的输入流。
     ...
     * @throws Exception
     */
    public static void getByName(String objectName, String fileName) throws Exception{
        if(checkByName(objectName)){
            // 获取的输入流。
     ...
     * @throws Exception
     */
    public static InputStream  getByName(String objectName, ServerSideEncryption key)throws Exception{
        InputStream  stream = null;
        if(checkByName(objectName)){
            // 获取的输入流。
     ...
     * @throws Exception
     */
    public static void putByName(String objectName, InputStream stream) throws Exception{
    ...
    public static String put(String bucketName, String objectName, MultipartFile multipartfile) throws Exception{
        ...
        return  getUrlByName(objectName);
    }
     ...
     * @throws Exception
     */
    public static String putByName(String objectName, MultipartFile multipartfile) throws Exception{
        InputStream stream = multipartfile.getInputStream();
        PutObjectOptions options = new PutObjectOptions(stream.available(),-1);
        options.setContentType(multipartfile.getContentType());
        minioClient.putObject(bucketName, objectName,stream,options);
     ...
     * @throws Exception
     */
    public static void putByName(String objectName, InputStream stream, PutObjectOptions options) throws Exception{
        minioClient.putObject(bucketName, objectName,stream,options);
    }
     ...
     * @throws Exception
     */
    public static void removeByName(String objectName) throws Exception{
     ...
     * @throws Exception
     */
    public static Iterable<Result<DeleteError>> removeByName(Iterable<String> objectNames) throws Exception{
